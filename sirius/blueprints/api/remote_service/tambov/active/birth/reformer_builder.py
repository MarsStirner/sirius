        ...
        if src_operation_code != OperationCode.DELETE:
            ...
            main_item['body'] = {
                ...
                'general_info': {
                    ...
                    'delivery_time': encode(stk(part1, 'ChildBirth', 'Time'))[:5] or '00:00',
                    ...
                    # --
                    'diagnosis_osn': dm.diag_code(stk(part1, 'ChildBirth', 'Diagnoses', 'MainDiagnoses')) or Undefined,
                    # --
                    ...
                    'maternity_hospital_doctor': (lambda x: x and str(x) or Undefined)(
                        self.get_employee_positions(stk(part1, 'ChildBirth', 'EmployeeId'))
                    ),
            ...
            for child in childs:
                ...
                kids.append({
                    ...
                    # --
                    'time': '00:00' if safe_bool(stk(child, 'Alive')) else Undefined,
