...
from sirius.blueprints.api.remote_service.tula.passive.checkup_pc_ticket25.xform import \
    CheckupPCTicket25TulaXForm
...
def api_checkup_pc_ticket25_change(api_version, **kwargs):
    ...
    xform = CheckupPCTicket25TulaXForm(api_version, stream_id)
    if not delete:
