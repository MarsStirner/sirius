...
def edit_checkup_second_ticket25(testapp, session, parent_id, main_id, data):
    url = u'/tula/api/integration/0/card/%s/checkup/obs/second/%s/ticket25' % (parent_id, main_id)
